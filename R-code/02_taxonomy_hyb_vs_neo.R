...
# check the taxonomic overlap between neophytes and hybrids
...
# Phylogenetic signal for freq of hybrids
traits <- tip_states_all_Tree$hyb_frac
names(traits) <- tip_states_all_Tree$genus

phySig <- phylosig(Tree, tip_states_all_Tree$hyb_frac, method = "K", test= T)
...
# Phylogenetic signal for freq of neophytes
traits <- tip_states_all_Tree$neo_frac
names(traits) <- tip_states_all_Tree$genus

phySig <- phylosig(Tree, tip_states_all_Tree$neo_frac, method = "K", test= T)
lambdaModel <- fitContinuous(Tree, traits, model = "lambda")
lambdaModel$opt$aicc
